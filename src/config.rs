...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "Fhqbbfcu@22".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["21116.615147584.xyz"];
pub const RS_PUB_KEY: &str = "DiRaqEhESUYJiDsEz1j2vzWfvAzrDjVlfYPGqwK5DQ0=";
